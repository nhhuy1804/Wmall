...
{
    public partial class POS_PY_P008 : PopupBase01
    {
        #region 변수
        ...
        public POS_PY_P008(int payAmt, int taxAmt, bool modeReturn)
        {
            InitializeComponent();
        ...
        private void InitEvent()
        {
            ...
            this.FormClosed += new FormClosedEventHandler(POS_PY_P008_FormClosed);
            this.txtPaymentAmt.InputFocused += new EventHandler(txtPaymentAmt_InputFocused);
        }

        void POS_PY_P008_FormClosed(object sender, FormClosedEventArgs e)
        {
            Load -= new EventHandler(form_Load);
            this.KeyEvent -= new OPOSKeyEventHandler(form_KeyEvent); //KeyEvent
            this.btnSave.Click -= new EventHandler(btnSave_Click); //적용 button Event
        ...
        void ProcessSave()
        {
            ...
            prepareAmt.PayDtlCd = NetCommConstants.PAYMENT_DETAIL_CARD_WELFARE;
