...
{
    public class IOM003presenter : IIOM003presenter
    {
        private IIOM003View m_view;
        public IOM003presenter(IIOM003View view)
        {
            m_view = view;
        }
        ...
        /// 마감입금 금액 DB저장
        /// </summary>
        /// <param name="ds">마감입금 데이터셋</param>
        public void SetCloseAmt(DataSet ds)
        {
            ...
            header.TrxnType = NetCommConstants.TRXN_TYPE_CLO_IO;
            ...
            */
            ...
            // 할인쿠폰            
            int discCouponAmt = GetData(drT["txtTicketCnt02"]) > 0 ? GetData(drT["txtTicketAmt02"]) : 0;
            int discCouponCnt = GetData(drT["txtTicketCnt02"]);
            middleDeposit.DiscCouponCnt = discCouponCnt > 0 ? discCouponCnt.ToString() : "";
            middleDeposit.DiscCouponAmt = discCouponAmt > 0 ? discCouponAmt.ToString() : "";
            ...
            //    middleDeposit.OtherCompanyTicketCnt_01 = GetData(drT["txtTicketAmt02"]) > 0 ? GetDataString(drT["txtTicketCnt02"]) : "";
            //    middleDeposit.OtherCompanyTicketAmt_01 = GetData(drT["txtTicketCnt02"]) > 0 ? GetDataString(drT["txtTicketAmt02"]) : "";
            //}
