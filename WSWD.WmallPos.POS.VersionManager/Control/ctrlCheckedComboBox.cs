...
{
    public class ctrlCheckedComboBox : ComboBox {
        /// <summary>
        ...
        internal class Dropdown : Form {
            ...
            internal class CustomCheckedListBox : CheckedListBox {
                ...
                protected override void OnKeyDown(KeyEventArgs e) {
                    if (e.KeyCode == Keys.Enter) {
                        // Enact selection.
                        ((ctrlCheckedComboBox.Dropdown) Parent).OnDeactivate(new CCBoxEventArgs(null, true));
                        e.Handled = true;

                    } else if (e.KeyCode == Keys.Escape) {
                        // Cancel selection.
                        ((ctrlCheckedComboBox.Dropdown) Parent).OnDeactivate(new CCBoxEventArgs(null, false));
                        e.Handled = true;
            ...
            private ctrlCheckedComboBox ccbParent;
            ...
            public Dropdown(ctrlCheckedComboBox ccbParent) {
        ...
        public ctrlCheckedComboBox() : base() {
